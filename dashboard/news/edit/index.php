...
if (isset($_POST["submit"])) {
    $error = updateNews($conn, $id, $_POST, $_FILES['image']);
    if ($error === false) {
        header("Location: /dashboard/news");
    } else {
        header("Location: /dashboard/news/edit?error=$error");
    }
    mysqli_close($conn);
    exit;
}
...
<head>
    ...
    <title>Rolex Admin Dashboard - Edit News</title>

    <meta name="description" content="Edit news articles and updates in the Rolex admin dashboard. Manage announcements, update content, and keep your users informed with the latest information.">
    <meta name="keywords" content="Rolex, admin dashboard, edit news, update news, Rolex admin, news management, Rolex announcements, Rolex updates, admin panel news">
    ...
    <div class="flex-1 p-6 lg:ml-64 transition-all">
        ...
        <form action="" method="POST" class="space-y-4 max-w-md" enctype="multipart/form-data">
            ...
            <div class="flex flex-col space-y-1">
                ...
                <input type="text" id="slug" name="slug" value="<?= $news['slug'] ?>" required
                       class="p-2 bg-[#333333] rounded-md outline-none focus:outline-[#444444]">
            </div>
            ...
            <div class="flex flex-col space-y-1">
                ...
                <textarea id="content" name="content" required
                          class="p-2 bg-[#333333] rounded-md outline-none focus:outline-[#444444] min-h-[100px] max-h-[300px]"><?= $news['content'] ?></textarea>
            </div>
