...
<head>
    ...
    <meta name="description" content="Access the Rolex admin dashboard to manage your luxury watch inventory, update sales, and track customer data securely. Admin login required.">
    <meta name="keywords" content="Rolex, admin dashboard, luxury watch inventory, Rolex admin, watch sales, admin login, secure access, Rolex management">
